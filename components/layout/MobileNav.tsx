...
export function MobileNav({ isOpen, onClose }: MobileNavProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          'fixed top-0 right-0 z-50 h-full w-[300px] bg-surface shadow-xl transition-transform duration-300 lg:hidden',
      ...
      >
        ...
        <nav className="p-4">
          ...
          <div className="mt-6 pt-6 border-t border-border space-y-3">
            ...
            <a href={`tel:${PHONE_NUMBER}`} className="flex items-center justify-center gap-2 px-4 py-3 text-navy font-medium hover:bg-surface-alt rounded-lg transition-colors">
