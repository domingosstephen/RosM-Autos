        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <p className="text-cta font-semibold text-sm uppercase tracking-wider mb-4">
              Trusted International Vehicle Exporter
            </p>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white leading-tight">
              Finding Reliable Vehicles and Equipment for Import{' '}
              <span className="text-cta">Shouldn&apos;t Be a Gamble</span>
            </h1>
            <p className="mt-6 text-lg text-white/70 leading-relaxed">
              Poor inspections, hidden fees, and unreliable shipping leave international buyers
              stuck with costly surprises. You deserve better.
            </p>
            <p className="mt-4 text-white/90 leading-relaxed">
              RosM Autos delivers quality-inspected automobiles, farm tractors, and electric bikes
              with transparent pricing and complete export service — from our lot to your port.
            </p>
